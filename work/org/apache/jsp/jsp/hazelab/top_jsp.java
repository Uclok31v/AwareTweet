 ...
 * Generated at: 2015-12-10 14:39:06 UTC
...
for(int i=1; i<=60; i++){ 
      ...
      out.write("\t<li class=\"active\"><a href=\"../hazelab/MoveTopServlet\"><span class=\"fui-home\"> ホーム</span></a></li>\n");
      out.write("    <li><a href=\"../hazelab/GetSlideServlet\"><span class=\"fui-play\"> スライド</span></a>\n");
      out.write("    </ul>\n");
      out.write("\n");
...
String userName = (String)userList.get(i);
      ...
      out.write("     <form action=\"../hazelab/TweetServlet\" method=\"post\">\n");
      out.write("      <div class=\"ui-widget\">\n");
      out.write("      <div class=\"form-group\">\n");
      out.write("       <label for=\"comment\"></label>\n");
      out.write("       <textarea name=\"comment\" id=\"comment\" cols=\"50\" rows=\"3\" class=\"form-control\" placeholder=\"いまどうしてる?\"></textarea>\n");
      out.write("      </div>\n");
      out.write("      </div>\n");
 ...
 Tweet tweet = (Tweet)tweetList.get(i); 
      ...
      out.write(" style=\"with: 30px; height: 30px;\"/>  <a href=\"../hazelab/GetUserTweetServlet?id=");
